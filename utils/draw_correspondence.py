...
def draw_correspondence(A, B, correspondence, radius, save_dir, level=0, k_final=None):
    A_marked = util.tensor2im(A)
    ...
    if k_final:
        A_name, B_name = f'A_level_{level}_top_{k_final}.png', f'B_level_{level}_top_{k_final}.png'
    else:
